...
対象は`feature/common-rust-transfer-engine`。共通Rust転送基盤、Web UIツールチェーン、Tauri native adapter、デスクトップ入口切替はそれぞれ`3d6400a`、`0cc621c`、`90e2c91`、`784ffde`以降へコミット済みである。以下の実機・配布・性能項目は現在のコミットで再確認していない。
