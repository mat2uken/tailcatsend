...
現在の unit test は Rust workspace 55件（core 14、transfer 17を含む）と Web UI 29件を対象にし、ヘッダー分割、本文同時受信、部分 I/O、取消、保存失敗、イベント順序、QR、受信一覧、Tauri picker forwarding、署名付き更新 manifest、更新版の検証保存、更新確認の時間切れを含める。
